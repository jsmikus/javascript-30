...
const oldest = inventors.sort((firstInventor, secondInventor) => firstInventor.year > secondInventor.year ? 1 : -1);
...
const longestLive = inventors.sort(((a, b) => {
    return (a.passed - a.year) > (b.passed - b.year) ? -1 : 1;
}));

console.table(longestLive);

// 6. create a list of Boulevards in Paris that contain 'de' anywhere in the name
// https://en.wikipedia.org/wiki/Category:Boulevards_in_Paris

// const domCategory = document.querySelector(".mw-category");
// const links = Array.from(domCategory.querySelectorAll("a"));
